<template>
    <section class="relative bg-neutral-50 pt-15 md:pt-20 pb-15 xs:pb-18 md:pb-32 overflow-hidden lg:pt-32">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div class="text-left space-y-7">
                    ...
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-light text-neutral-900 tracking-tight leading-[1.1]">
                        Life admin, without the calendar.
                    </h1>
                    <p class="text-base sm:text-lg text-neutral-600 leading-relaxed max-w-lg">
                    ...
                    <NuxtLink to="/register" class="px-8 py-3.5 text-base font-semibold text-white text-center bg-primary-500 rounded-lg shadow-lg shadow-primary-500/30 hover:bg-primary-600 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300">
                        Join the waitlist
                    </NuxtLink >
                ...
                <div class="relative lg:ml-auto w-full max-w-lg max-lg:mx-auto">
                    <div class="relative rounded-2xl bg-white shadow-2xl border border-neutral-100 overflow-hidden transform md:rotate-2">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <!-- Mock Items -->
                        <div v-for="item in items" :key="item.title" class="flex flex-wrap sm:flex-nowrap items-center p-3 rounded-lg bg-neutral-50 border border-neutral-100 hover:border-primary-200 transition-colors">
                            ...
                            <div class="text-sm text-neutral-400 flex items-center gap-2 ml-4 xs:ml-0">
                    ...
                    <!-- Floating Badge -->
                    <div class="hidden sm:block absolute -top-6 -right-6 animate-bounce">
